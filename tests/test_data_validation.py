...
class TestDataValidation(unittest.TestCase):
    ...
    def test_no_empty_dataframe_output(self):
        ...
        result = transform(df)
        self.assertGreater(len(result), 0, "Transform should not return empty DataFrame")
...
class TestDataQuality(unittest.TestCase):
    ...
    def test_referential_integrity(self):
        ...
        invalid_refs = orders_df[~orders_df['customer_id'].isin(customers_df['customer_id'])]
